...
import com.selene.volley.cache.Cache.Entry;
...
import com.selene.volley.core.NetworkError;
import com.selene.volley.core.NetworkResponse;
import com.selene.volley.core.NoConnectionError;
import com.selene.volley.core.RedirectError;
import com.selene.volley.core.Request;
import com.selene.volley.core.RetryPolicy;
import com.selene.volley.core.ServerError;
import com.selene.volley.core.TimeoutError;
...
//				}
	...
	private void logSlowRequests(long requestLifetime, Request<?> request, byte[] responseContents, StatusLine statusLine) {
		if (DEBUG || requestLifetime > SLOW_REQUEST_THRESHOLD_MS) {
			VolleyLog.d("HTTP response for request=<%s> [lifetime=%d], [size=%s], " + "[rc=%d], [retryCount=%s]", request, requestLifetime, responseContents != null ? responseContents.length : "null", statusLine.getStatusCode(), request.getRetryPolicy().getCurrentRetryCount());
		}
	}
